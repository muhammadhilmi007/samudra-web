...
const PickupRequestForm: React.FC<PickupRequestFormProps> = ({
  ...
  const handleFormSubmit = (data: PickupRequestFormInputs) => {
    ...
    const validateNewCustomer = () => {
      if (!newCustomer.nama) {
        toast({
          message: "Validasi Gagal: Nama pelanggan harus diisi",
          type: "error"
        });
        return false;
      }
      ...
      if (!newCustomer.telepon) {
        toast({
          message: "Validasi Gagal: Nomor telepon pelanggan harus diisi",
          type: "error"
        });
        return false;
      }
      ...
      if (!newCustomer.alamat) {
        toast({
          message: "Validasi Gagal: Alamat pelanggan harus diisi",
          type: "error"
        });
        return false;
      }
    ...
    const handleCreateCustomer = () => {
      ...
      // Here you'd dispatch to create the customer in a real scenario
