...
import { getCustomers, getSenders, getRecipients } from '../../store/slices/customerSlice';
                    ...
                    <Controller
                      ...
                      render={({ field: { onChange, value, ...field } }) => (
                        <Autocomplete
                          ...
                          value={customerOptions.find((c) => c._id === value) || null}
                          onChange={(_, newValue) => {
              ...
              <Paper sx={{ p: 3 }}>
                ...
                {!pelangganId ? (
                  <Alert severity="info" sx={{ mb: 2 }}>
                    Silahkan pilih pelanggan terlebih dahulu untuk melihat STT yang tersedia.
                  </Alert>
                ) : filteredSTTs.length === 0 ? (
                  <Alert severity="warning" sx={{ mb: 2 }}>
                    Tidak ada STT yang tersedia untuk ditagih untuk pelanggan ini.
                  </Alert>
                ) : (
                  <>
                    <Controller
                          ...
                          <Select
                            ...
                            renderValue={(selected) => (
                              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.5 }}>
                                {selected.map((value) => {
                                  const stt = filteredSTTs.find((s) => s._id === value);
                                  return (
                                    <Chip 
                                      key={value} 
                          ...
                          >
                            {filteredSTTs.map((stt) => (
                              <MenuItem key={stt._id} value={stt._id}>
                                <FormControlLabel
                                  control={
                                    <Checkbox checked={value.includes(stt._id)} />
                                  }
                                  label={
                                    <Box>
              ...
              <Paper sx={{ p: 3, position: 'sticky', top: '80px' }}>
                ...
                <Box sx={{ mb: 3 }}>
                  ...
                  <Chip 
                    label={tipePelanggan}
                    size="small"
                    color={tipePelanggan === 'Pengirim' ? 'primary' : 'secondary'}
                  />
                </Box>
                ...
                <Box sx={{ mt: 4 }}>
                  ...
                  >
                    {loading ? <CircularProgress size={24} /> : 'Buat Penagihan'}
                  </Button>
                </Box>
              </Paper>
            </Grid>
