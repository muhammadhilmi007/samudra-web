...
const PickupRequestDetailPage: NextPage = () => {
  ...
  const [pendingStatus, setPendingStatus] = useState<'PENDING' | 'FINISH'>('PENDING');
  ...
  return (
    <Layout>
      ...
      <div className="bg-white shadow overflow-hidden sm:rounded-lg">
        <div className="px-4 py-5 sm:px-6 flex justify-between items-center">
          ...
          <div>
            <button 
              onClick={() => {
                setPendingStatus(pickupRequest.status === 'PENDING' ? 'FINISH' : 'PENDING');
            ...
            >
              {pickupRequest.status === 'PENDING' ? 'Selesaikan' : 'Kembalikan ke Pending'}
            </button>
          </div>
        </div>
        <div className="border-t border-gray-200">
          <dl>
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">Tanggal Permintaan</dt>
            ...
            <div className="bg-gray-50 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">Telepon Pengirim</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
                {pickupRequest.pengirim?.telepon || '-'}
              </dd>
            </div>
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">Alamat Pengambilan</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
            ...
            <div className="bg-white px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-500">Jumlah Colly</dt>
              <dd className="mt-1 text-sm text-gray-900 sm:mt-0 sm:col-span-2">
      ...
      <ConfirmDialog 
        ...
        message={`Apakah Anda yakin ingin mengubah status menjadi ${
